...
import { Star, Shield, X, Loader2, Check, AlertTriangle } from 'lucide-react';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const subscriptionData = {
        ...
        trialEndDate: addMonths(new Date(), 1).toISOString(),
      ...
      toast.success('Successfully upgraded to Featured Agent!');
      onSuccess();
      onClose();
    } catch (error) {
